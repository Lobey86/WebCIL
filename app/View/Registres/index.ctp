        ...
        foreach ($fichesValid as $key => $value) {
            ...
            <tr>
                ...
                <td class="tdleft">
                    ...
                    echo $this->Html->link('<span class="glyphicon glyphicon-lock"></span>', array('controller'=>'etatFiches', 'action'=>'archive', $value['Fiche']['id']), array('class'=>'btn btn-danger boutonArchive boutonsAction15', 'escapeTitle'=>false), 'Voulez-vous archiver vette fiche? Une fois archivée, toute modification est impossible.');
                } 
                echo '</td>
            </tr>';
        }
