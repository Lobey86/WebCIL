...
abstract class FusionConvConverterCloudooo extends FusionConvAbstractConverter
{
    ...
    protected static function _xmlRpc2Convert($content, $inputFormat, $outputFormat)
    {
        ...
        Debugger::log(var_export($params, true));
        ...
        try {
            ...
            Debugger::log(sprintf($errorMsgid, $uri, $XML_RPC2_CurlException->getCode(), $message));
            return false;
        } catch(Exception $Exception) {
            Debugger::log(sprintf($errorMsgid, $uri, $Exception->getCode(), $Exception->getMessage()));
            return false;
        }
