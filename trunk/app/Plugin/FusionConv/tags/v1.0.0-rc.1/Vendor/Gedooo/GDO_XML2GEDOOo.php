 ...
 * ---------------
 * Cette classe fournit les fonctionnalitÃ©s pour transformer
 * une chaÃ®ne XML conforme Ã  la premiÃ¨re version de GED'OOo
 * en objets conformes Ã  la derniÃ¨re version
 *
 * Version 1.0
 */
...
Class GDO_XML2GEDOOo {
    ...
    /**
     * Convertit un Ã©lÃ©ment "champ" en FieldType
     *
	 * @param    objet		L'Ã©lÃ©ment XML de type "champ"
...
function ElmtToField($oElmt) {
    ...
    /**
     * Convertit un Ã©lÃ©ment "bloc" en IterationType
     *
	 * @param    objet		L'Ã©lÃ©ment XML de type "bloc"
...
//	echo "<br>Iteration ". (string)$oElmt["nom"] ."<br>";
    ...
    /**
     * Convertit un Ã©lÃ©ment "champ" de type "image" ou "contenu" en ContentType
     *
     * @param    objet		L'Ã©lÃ©ment XML de type "champ"
...
$aElements = array();
    ...
    /**
     * Convertit un Ã©lÃ©ment "champ" soit en FieldType soi en ContentType.
...
function ElmtToMatrix($oElmt) {
	...
	// normalement en premiÃ¯Â¿Â½re position		
...
function ElmtToAxisTitles($oElmt) {
    ...
    /**
     * Convertit un Ã©lÃ©ment "ligne" en PartType
     *
	 * @param    objet		L'Ã©lÃ©ment XML de type "ligne"
