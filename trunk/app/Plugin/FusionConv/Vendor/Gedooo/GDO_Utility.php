...
return $sData;
     ...
     * @param    binary      $bData Le contenu ï¿½ ï¿½crire
     * @since    1.0
     * @access   public
     */
 ...
 */
    ...
    /**
     * Dï¿½termination d'un type MIME ï¿½ partir d'une extension
     *
...
function extensionToMimeType($sExtension){
    ...
    /**
     * Dï¿½termination d'un type MIME ï¿½ partir d'un nom de fichier
     *
...
function mimeTypeToExtension($sMimeType) {
    ...
    /**
     * Ajout d'une extension ï¿½ un nom de fichier
     *
