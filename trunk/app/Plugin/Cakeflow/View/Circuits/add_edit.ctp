...
echo $this->Form->input('Circuit.nom', array(
    'size' => '100',
    'label' => __('Nom', true)
));
echo $this->Form->input('Circuit.description', array(
...
if(CAKEFLOW_GERE_DEFAUT) echo $this->Form->input('Circuit.defaut', array('label' => __('Circuit par défaut', true))); else
...
echo $this->Html->link('<i class="fa fa-arrow-left"></i> Annuler', array('action' => 'index'), array(
    'class' => 'btn',
    'escape' => false,
    'title' => 'Annuler'
));
echo $this->Form->button('<i class="fa fa-check"></i> Valider', array(
    'type' => 'submit',
    'id' => 'boutonValider',
    'class' => 'btn btn-default-primary',
    'escape' => false,
    'title' => 'Enregistrer le circuit de traitement'
));
echo $this->Html->tag('/div', null);
echo $this->Html->tag('/div', null);
echo $this->Form->end();
