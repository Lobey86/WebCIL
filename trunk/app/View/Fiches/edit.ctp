...
echo $this->Form->input('nomoutil', array('div'=>'input-group input-group-sm inputsFormLeft', 'label'=>false, 'before' => '<span class="labelFormulaire">Nom de l\'outil</span>', 'class'=>'form-control'));
echo $this->Form->input('finalite', array('div'=>'input-group input-group-sm inputsFormLeft', 'label'=>false, 'before' => '<span class="labelFormulaire">Finalité principale</span>', 'class'=>'form-control'));
...
echo '<span class="labelFormulaire">Public concerné par le traitement</span>';
...
<fieldset>
    ...
    <table class="table-hover table-striped tableauFichiers">
        <tbody>
            <tr>
                <td>
                ...
                <td>
                    Fichier d'exemple.pdf
                </td>
                <td>
                    30,0 Ko
                </td>
                <td>
                    <button type='button' class='btn btn-default boutonDl boutonsAction5'><span class='glyphicon glyphicon-download-alt'></span></button>
                    <button type='button' class='btn btn-danger boutonDelete boutonsAction5'><span class='glyphicon glyphicon-trash'></span></button>
                </td>
            </tr>
            <tr>
                <td>
...
<?php
echo $this->Html->link('Annuler', array('controller'=>'pannel', 'action'=>'index'), array('class'=>'btn btn-danger pull-right sender'), 'Voulez-vous vraiment annuler ces modifications?');
