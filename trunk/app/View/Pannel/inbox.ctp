                    ...
                    <tr>
                        ...
                        <td class='tdleft col-md-2 col-md-offset-10'>
                            <div class="btn-group">
                                ...
                                <button class='btn btn-default-success dropdown-toggle boutonValider btn-sm my-tooltip'
                                        type='button'
                                ...
                                <ul class='dropdown-menu' role='menu' aria-labelledby='dropdownMenuValider'>
                                    ...
                                    if(!$this->Autorisation->isCil()) {
                                        ...
                                        echo "
                                                <li role='presentation'>" . $this->Html->link('Valider la fiche et l\'insérer dans le registre', array('#' => '#'), array(
                                                'role' => 'menuitem',
                                                'tabindex' => '-1',
                                                'data-toggle' => 'modal',
                            ...
                            <button type='button' class='btn btn-default-danger boutonRefuser btn-sm my-tooltip'
            ...
            <div class="modal-body">
                ...
                <div class="row top17">
                    <div class="col-md-12">
                        ...
                        echo $this->Form->hidden('idfiche', array('id' => 'idFiche'));
                        ?>
                    </div>
                </div>
            </div>
