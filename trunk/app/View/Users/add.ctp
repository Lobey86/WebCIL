...
<div class="users form">
    ...
    <div class="input-group login">
        ...
        echo $this->Form->input('Organisation.Organisation_ida', array('options' => $listeOrganisations, 'class' => 'form-control', 'id' => 'deroulant', 'label' => false, 'multiple' => 'multiple', 'selected' => '1')); ?>
    </div>
    <?php
    foreach($tableau['Organisation'] as $key => $datas){
        $listeroles=array();
